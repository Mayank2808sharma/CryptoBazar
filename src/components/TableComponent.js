    ...
    >
      <svg
        className={`w-[1.5rem] ml-1.5 ${
          allCoins.includes(data.id) ? "fill-green" : "fill-gray-100"
        } hover:fill-green`}
        width="30"
        height="30"
        viewBox="0 0 30 30"
...
const TableComponent = () => {
  ...
  return (
    <>
          ...
          <table className="w-full table-auto">
            ...
            <tbody>
              {cryptoData.map((data) => (
                <tr
                  key={data.id}
                  className="text-center text-base border-b border-gray-100 hover:bg-gray-100 last:border-b-0"
                >
                  ...
                  <td
                    className={`py-4 hidden lg:table-cell ${
      ...
      <div className="flex items-center justify-between mt-4 capitalize h-[2rem] py-8">
        <span>
          Data provided by{" "}
          <a
